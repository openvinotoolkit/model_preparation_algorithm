...
from mpa.apis.configs.detection import MPADetectionParameters
...
class MPADetectionTask(MPABaseTask):
    ...
    def get_configurable_parameters(task_environment: TaskEnvironment) -> ConfigurableParameters:
        return task_environment.get_configurable_parameters(instance_of=MPADetectionParameters)
