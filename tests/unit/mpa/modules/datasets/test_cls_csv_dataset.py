...
from mpa.modules.datasets.cls_csv_dataset import CSVDatasetCls
...
class TestMultiClassDataset(unittest.TestCase):
    def setUp(self):
        ...
        self.anno_file = os.path.join(self.assets_path, 'csvs/dss18.anno.single_cls.csv')
        self.classes = ["Other", "Senior", "Kids", "Unknown"]
        self.data_cfg = dict(
            type=dataset_type,
    ...
    def test_build_dataset(self):
        ...
        self.assertTrue(isinstance(dataset, CSVDatasetCls))
    ...
    def test_evaluate(self):
        dataset = build_dataset(self.data_cfg)
        dummy_res = [np.array([[1., 0., 0.]]) for i in range(10)]
