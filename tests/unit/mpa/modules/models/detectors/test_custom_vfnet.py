import pytest
import torch
from mpa.modules.models.detectors.custom_vfnet_detector import CustomVFNet
...
@pytest.mark.priority_high
@pytest.mark.unit
def test_custom_vfnet_load_state_dict_pre_hook():
    ...
    class Model:
        def state_dict(self):
            return model_dict
    CustomVFNet.load_state_dict_pre_hook(
